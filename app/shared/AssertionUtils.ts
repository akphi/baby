import type { GenericClazz, PlainObject } from "./CommonUtils";

export class AssertionError extends Error {
  constructor(error: string | Error | undefined, message?: string) {
    super(`Assertion Error${message ? `:${message}` : ""}`, { cause: error });
  }
}
...
export function guaranteeNonEmptyString(str: unknown, message = ""): string {
